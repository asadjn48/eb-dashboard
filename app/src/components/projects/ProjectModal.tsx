           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="space-y-1.5">
                 ...
                 {/* <Input required type="number" placeholder="0.00" value={formData.budget || ''} onChange={e => setFormData({...formData, budget: Number(e.target.value)})} className="h-10 bg-emerald-50/30 border-emerald-100 focus-visible:ring-emerald-500 font-mono font-bold text-lg" /> */}
                  <Input required type="number" placeholder="0.00" value={formData.budget || ''} onChange={e => setFormData({...formData, budget: Number(e.target.value) as any})} className="h-10 bg-emerald-50/30 border-emerald-100 focus-visible:ring-emerald-500 font-mono font-bold text-lg" />              </div>
