...
//                <p className="text-xs text-gray-500 uppercase tracking-wider">{record.month} • {record.id}</p>
//             </div>
...
//                   <span className="font-medium text-gray-900">{record.paidDate}</span>
//                </div>
//             </div>

//             <div className="bg-gray-50 p-3 rounded text-xs space-y-2">
//                <div className="flex justify-between"><span>Base Salary</span> <span>{formatCurrency(record.baseSalary)}</span></div>
//                <div className="flex justify-between text-green-600"><span>Bonus</span> <span>+{formatCurrency(record.bonuses)}</span></div>
//                <div className="flex justify-between text-red-600"><span>Deductions</span> <span>-{formatCurrency(record.deductions + record.tax)}</span></div>
//             </div>
//          </div>
