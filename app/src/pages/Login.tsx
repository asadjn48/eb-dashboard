...
//                 value={email}
//                 onChange={(e) => setEmail(e.target.value)}
//                 className="h-12 bg-transparent border-0 border-b-[1.5px] border-slate-300 rounded-none px-1 text-base placeholder:text-slate-400 focus-visible:ring-0 focus-visible:border-[#6C63FF] transition-colors pr-10"
//                 required
//               />
//               <button
//                 type="button"
...
//                   activeMic === 'email' ? "text-white bg-red-500 animate-pulse" : "text-slate-400 hover:text-[#6C63FF]"
//                 )}
//                 title="Dictate Email"
//               >
...
//                   activeMic === 'password' ? "text-white bg-red-500 animate-pulse" : "text-slate-400 hover:text-[#6C63FF]"
//                 )}
...
//                   type="button"
//                   onClick={() => { setView('forgot'); setResetSent(false); }}
//                   className="text-[13px] text-slate-500 hover:text-[#6C63FF] transition-colors"
//                 >
//                   Forgot password?
//                 </button>
//               </div>
...
//             <Button
//               type="submit"
//               className="w-full h-12 mt-4 rounded-[8px] bg-[#6C63FF] hover:bg-[#5A52E0] text-white text-[15px] font-medium transition-all shadow-sm"
//               disabled={isLoading}
//             >
//               {isLoading ? <Loader2 className="mr-2 h-5 w-5 animate-spin" /> : 'login'}
//             </Button>
...
//                   <p className="text-[13px] text-slate-500 mt-2 mx-auto leading-relaxed">
//                     We've sent recovery instructions to <br/>
//                     <span className="font-medium text-[#6C63FF]">{email}</span>
//                   </p>
//                 </div>
//                 <Button 
//                   variant="ghost" 
//                   onClick={() => setView('login')} 
//                   className="w-full h-12 mt-4 text-[#6C63FF] hover:text-[#5A52E0] hover:bg-transparent text-[14px]"
//                 >
//                   Back to login
//                 </Button>
//               </div>
...
//                   <Button 
//                     type="submit" 
//                     className="w-full h-12 rounded-[8px] bg-[#6C63FF] hover:bg-[#5A52E0] text-white text-[15px] font-medium transition-all shadow-sm" 
//                     disabled={isLoading}
//                   >
//                     {isLoading ? <Loader2 className="mr-2 h-5 w-5 animate-spin" /> : 'Send reset link'}
//                   </Button>
...
//                     type="button" 
//                     variant="ghost" 
//                     className="w-full h-12 text-slate-500 hover:text-[#6C63FF] hover:bg-transparent transition-colors text-[14px]"
//                     onClick={() => setView('login')}
//                   >
//                     Back to login
//                   </Button>
          ...
          <form onSubmit={handleLoginSubmit} className="space-y-6 animate-in fade-in slide-in-from-left-4 duration-300">
            ...
            <div className="space-y-1 relative">
              <Input
                ...
                className={cn(
                  "h-12 bg-transparent border-0 border-b-[1.5px] rounded-none px-1 text-base placeholder:text-slate-400 focus-visible:ring-0 focus-visible:border-[#6C63FF] transition-colors pr-10",
                  activeField === 'email' && isListening ? "border-[#6C63FF] bg-[#6C63FF]/5" : "border-slate-300"
                )}
                required
              />
              <button
                ...
                className={cn(
                  "absolute right-1 top-1/2 -translate-y-1/2 p-2 rounded-full transition-all",
                  isListening && activeField === 'email' ? "text-red-500 animate-pulse" : "text-slate-400 hover:text-[#6C63FF]"
                )}
            ...
            <div className="space-y-2 relative">
              <Input
                ...
                className={cn(
                  "h-12 bg-transparent border-0 border-b-[1.5px] rounded-none px-1 text-base placeholder:text-slate-400 focus-visible:ring-0 focus-visible:border-[#6C63FF] transition-colors pr-10",
                  activeField === 'password' && isListening ? "border-[#6C63FF] bg-[#6C63FF]/5" : "border-slate-300"
                )}
                required
              />
              <button
                ...
                className={cn(
                  "absolute right-1 top-[14px] p-2 rounded-full transition-all",
                  isListening && activeField === 'password' ? "text-red-500 animate-pulse" : "text-slate-400 hover:text-[#6C63FF]"
                )}
                title="Toggle Voice Assistant"
              >
                {isListening ? <Mic className="w-5 h-5" /> : <MicOff className="w-5 h-5" />}
